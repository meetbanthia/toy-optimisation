...
// =============================================================================
// 3DGRT NAVIGATION INDEX  (line numbers reference the ORIGINAL header before
// this index was prepended — add ~37 lines for this annotated copy, or grep
// for the symbol names. The class declares 3DGS-raster, 3DGUT, and 3DGRT
// members in one place — only the 3DGRT subset is listed below.)
//
//   Methods
//     L266   initRtDescriptorSet()
//     L268   initRtPipeline()
//     L269   raytrace(cmdBuf, meshDepthOnly = false)
//
//   Shader modules (compiled in gaussian_splatting.cpp L1767-1776)
//     L392   rtxRgenShader     — primary ray generator
//     L393   rtxRmissShader    — miss
//     L394   rtxRmiss2Shader   — shadow miss
//     L395   rtxRchitShader    — closest-hit for meshes
//     L396   rtxRahitShader    — any-hit (gaussian alpha-blend stops here)
//     L397   rtxRintShader     — custom intersection for splat AABBs
//     L403   particleAsBuildShader — compute that builds per-particle AABBs
//
//   Compute pipeline (particle AS build)
//     L415   m_computePipelineParticleAs
//     L426   m_particleAsPipelineLayout
//
//   RT pipeline & resources
//     L437   m_rtProperties        (VkPhysicalDeviceRayTracingPipelinePropertiesKHR)
//     L440   m_rtShaderGroups      (VkRayTracingShaderGroupCreateInfoKHR vector)
//     L441   m_rtPipelineLayout
//     L442   m_rtPipeline
//     L444   m_rtDescriptorBindings
//     L445   m_rtDescriptorSetLayout
//     L446   m_rtDescriptorSet
//     L447   m_rtDescriptorPool
//     L451   m_rtSBTBuffer         (shader binding table, shared with mesh path)
// =============================================================================
